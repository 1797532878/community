...
public class MessageController implements CommunityConstant {
    ...
    public String deleteLetter(String conversationId,String content){
        //messageService.deleteLetterMessage(conversationId, content);
    ...
    public String getNoticeDetail(@PathVariable("topic")String topic,Page page,Model model){
        ...
        model.addAttribute("hostUserId",hostHolder.getUser().getId());
        return "/site/notice-detail";
    }

    @RequestMapping(path = "/notice/delete/{topic}",method = RequestMethod.POST)
    @ResponseBody
    public String deleteNotice(@PathVariable("topic")String topic,int fromId,int toId){
        messageService.dleNotice(topic,fromId,toId);
